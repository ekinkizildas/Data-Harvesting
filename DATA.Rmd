...
all_movies <- future_map_dfr(languages, fetch_movies_by_language, .options = furrr_options(seed = TRUE))
...
all_movies_regional_release_dates <- future_map_dfr(split(all_movies, seq(nrow(all_movies))), fetch_regional_release_dates, .progress = TRUE)
